...
/*!
   ...
   * @version 3.0.0
   * @date 2/27/2025, 8:25:46 AM
   * @author AntVis
   * @docs https://g.antv.antgroup.com/
   */function A(t,r,e,n){var o=t-e,i=r-n;return Math.sqrt(o*o+i*i)}function I(t,r,e,n,o,i){var a=-1,u=1/0,c=[e,n],f=20;i&&i>200&&(f=i/10);for(var l=1/f,s=l/10,h=0;f>=h;h++){var v=h*l,y=[o.apply(void 0,E(t.concat([v]))),o.apply(void 0,E(r.concat([v])))],p=A(c[0],c[1],y[0],y[1]);u>p&&(a=v,u=p)}if(0===a)return{x:t[0],y:r[0]};if(1===a){var d=t.length;return{x:t[d-1],y:r[d-1]}}u=1/0;for(var g=0;32>g&&1e-4<=s;g++){var m=a-s,b=a+s,w=[o.apply(void 0,E(t.concat([m]))),o.apply(void 0,E(r.concat([m])))],x=A(c[0],c[1],w[0],w[1]);if(m>=0&&u>x)a=m,u=x;else{var P=[o.apply(void 0,E(t.concat([b]))),o.apply(void 0,E(r.concat([b])))],O=A(c[0],c[1],P[0],P[1]);1>=b&&u>O?(a=b,u=O):s*=.5}}return{x:o.apply(void 0,E(t.concat([a]))),y:o.apply(void 0,E(r.concat([a])))}}function F(t,r,e,n,o,i){var a=[e-t,n-r];if(function(t,r){return t[0]===r[0]&&t[1]===r[1]}(a,[0,0]))return Math.sqrt((o-t)*(o-t)+(i-r)*(i-r));var u=[-a[1],a[0]];return function(t,r){var e=r[0],n=r[1],o=e*e+n*n;o>0&&(o=1/Math.sqrt(o)),t[0]=r[0]*o,t[1]=r[1]*o}(u,u),Math.abs(function(t,r){return t[0]*r[0]+t[1]*r[1]}([o-t,i-r],u))}function T(t,r,e,n,o){var i=1-o;return i*i*i*t+3*r*o*i*i+3*e*o*o*i+n*o*o*o}function C(t,r,e,n,o,i,a,u,c,f,l){var s=function(t,r,e,n,o,i,a,u,c,f,l){return I([t,e,o,a],[r,n,i,u],c,f,T,l)}(t,r,e,n,o,i,a,u,c,f,l);return A(s.x,s.y,c,f)}function _(t,r,e,n){var o=1-n;return o*o*t+2*n*o*r+n*n*e}function G(t,r,e,n,o,i,a,u){var c=function(t,r,e,n,o,i,a,u){return I([t,e,o],[r,n,i],a,u,_)}(t,r,e,n,o,i,a,u);return A(c.x,c.y,a,u)}function W(t,e,n){var o=t.parsedStyle,i=o.cx,a=o.cy,u=o.r,c=o.fill,f=o.stroke,l=o.lineWidth,s=o.increasedLineWidthForHitTesting,h=o.pointerEvents,v=void 0===h?"auto":h,y=((void 0===l?1:l)+(void 0===s?0:s))/2,p=A(void 0===i?0:i,void 0===a?0:a,e.x,e.y),d=M(r.isFillOrStrokeAffected(v,c,f),2),g=d[0],m=d[1];return g&&m||n?u+y>=p:g?u>=p:!!m&&(p>=u-y&&u+y>=p)}function N(t,r,e,n){return t/(e*e)+r/(n*n)}function H(t,e,n){var o=t.parsedStyle,i=o.cx,a=void 0===i?0:i,u=o.cy,c=void 0===u?0:u,f=o.rx,l=o.ry,s=o.lineWidth,h=void 0===s?1:s,v=o.increasedLineWidthForHitTesting,y=void 0===v?0:v,p=o.pointerEvents,d=e.x,g=e.y,m=M(r.isFillOrStrokeAffected(void 0===p?"auto":p,o.fill,o.stroke),2),b=m[0],w=m[1],x=(h+y)/2,P=(d-a)*(d-a),O=(g-c)*(g-c);return b&&w||n?1>=N(P,O,f+x,l+x):b?1>=N(P,O,f,l):!!w&&(N(P,O,f-x,l-x)>=1&&1>=N(P,O,f+x,l+x))}function R(t,r,e,n,o,i){return!(t>o||o>t+e||r>i||i>r+n)}function q(t,r,e,n,o,i,a,u){var c=(Math.atan2(u-r,a-t)+2*Math.PI)%(2*Math.PI),f={x:t+e*Math.cos(c),y:r+e*Math.sin(c)};return A(f.x,f.y,a,u)<=i/2}function D(t,r,e,n,o,i,a){var u=o/2;return!(Math.min(t,e)-u>i||i>Math.max(t,e)+u||Math.min(r,n)-u>a||a>Math.max(r,n)+u)&&F(t,r,e,n,i,a)<=o/2}function B(t,r,e,n,o){var i=t.length;if(2>i)return!1;for(var a=0;i-1>a;a++){if(D(t[a][0],t[a][1],t[a+1][0],t[a+1][1],r,e,n))return!0}if(o){var u=t[0],c=t[i-1];if(D(u[0],u[1],c[0],c[1],r,e,n))return!0}return!1}function Y(t){return 1e-6>Math.abs(t)?0:0>t?-1:1}function U(t,r,e){return!((e[0]-t[0])*(r[1]-t[1])!=(r[0]-t[0])*(e[1]-t[1])||Math.min(t[0],r[0])>e[0]||e[0]>Math.max(t[0],r[0])||Math.min(t[1],r[1])>e[1]||e[1]>Math.max(t[1],r[1]))}function Q(t,r,e){var n=!1,o=t.length;if(2>=o)return!1;for(var i=0;o>i;i++){var a=t[i],u=t[(i+1)%o];if(U(a,u,[r,e]))return!0;Y(a[1]-e)>0!=Y(u[1]-e)>0&&0>Y(r-(e-a[1])*(a[0]-u[0])/(a[1]-u[1])-a[0])&&(n=!n)}return n}function X(t,r,e){for(var n=!1,o=0;t.length>o;o++){if(n=Q(t[o],r,e))break}return n}function Z(t,e,n){var o=t.parsedStyle,i=o.x1,a=o.y1,u=o.x2,c=o.y2,f=o.lineWidth,l=void 0===f?1:f,s=o.increasedLineWidthForHitTesting,h=void 0===s?0:s,v=o.pointerEvents;return!(!M(r.isFillOrStrokeAffected(void 0===v?"auto":v,o.fill,o.stroke),2)[1]&&!n||!l)&&D(i,a,u,c,l+h,e.x,e.y)}function $(t,e,n,o,i,a){var u=t.parsedStyle,c=u.lineWidth,f=void 0===c?1:c,l=u.increasedLineWidthForHitTesting,s=void 0===l?0:l,h=u.d,v=u.pointerEvents,y=h.segments,p=h.hasArc,d=h.polylines,g=h.polygons,m=M(r.isFillOrStrokeAffected(void 0===v?"auto":v,(null==g?void 0:g.length)&&u.fill,u.stroke),2),b=m[0],w=m[1],x=r.getOrCalculatePathTotalLength(t),P=!1;return b||n?P=p?o(t,e):X(g,e.x,e.y)||X(d,e.x,e.y):((w||n)&&(P=function(t,r,e,n,o){for(var i=!1,a=r/2,u=0;t.length>u;u++){var c=t[u],f=c.currentPoint,l=c.params,s=c.prePoint,h=c.box;if(!h||R(h.x-a,h.y-a,h.width+r,h.height+r,e,n))switch(c.command){case"L":case"Z":if(i=D(s[0],s[1],f[0],f[1],r,e,n))return!0;break;case"Q":if(i=r/2>=G(s[0],s[1],l[1],l[2],l[3],l[4],e,n))return!0;break;case"C":if(i=r/2>=C(s[0],s[1],l[1],l[2],l[3],l[4],l[5],l[6],e,n,o))return!0;break;case"A":c.cubicParams||(c.cubicParams=L(s[0],s[1],l[1],l[2],l[3],l[4],l[5],l[6],l[7],void 0));for(var v=c.cubicParams,y=s,p=0;v.length>p;p+=6){var d=C(y[0],y[1],v[p],v[p+1],v[p+2],v[p+3],v[p+4],v[p+5],e,n,o);if(y=[v[p+4],v[p+5]],i=r/2>=d)return!0}}}return i}(y,f+s,e.x,e.y,x)),P)}function z(t,e,n){var o=t.parsedStyle,i=o.lineWidth,a=void 0===i?1:i,u=o.increasedLineWidthForHitTesting,c=void 0===u?0:u,f=o.points,l=o.pointerEvents,s=M(r.isFillOrStrokeAffected(void 0===l?"auto":l,o.fill,o.stroke),2),h=s[0],v=!1;return(s[1]||n)&&(v=B(f.points,a+c,e.x,e.y,!0)),v||!h&&!n||(v=Q(f.points,e.x,e.y)),v}function J(t,e,n){var o=t.parsedStyle,i=o.lineWidth,a=void 0===i?1:i,u=o.increasedLineWidthForHitTesting,c=void 0===u?0:u,f=o.points,l=o.pointerEvents;return!(!M(r.isFillOrStrokeAffected(void 0===l?"auto":l,o.fill,o.stroke),2)[1]&&!n||!a)&&B(f.points,a+c,e.x,e.y,!1)}function K(t,e,n,o,i){var a=t.parsedStyle,u=a.radius,c=a.lineWidth,f=void 0===c?1:c,l=a.increasedLineWidthForHitTesting,s=void 0===l?0:l,h=a.x,v=void 0===h?0:h,y=a.y,p=void 0===y?0:y,d=a.width,g=a.height,m=a.pointerEvents,b=M(r.isFillOrStrokeAffected(void 0===m?"auto":m,a.fill,a.stroke),2),w=b[0],x=b[1],P=f+s;if(u&&u.some((function(t){return 0!==t}))){var O=!1;return(x||n)&&(O=function(t,r,e,n,o,i,a,u){var c=M(o,4),f=c[0],l=c[1],s=c[2],h=c[3];return D(t+f,r,t+e-l,r,i,a,u)||D(t+e,r+l,t+e,r+n-s,i,a,u)||D(t+e-s,r+n,t+h,r+n,i,a,u)||D(t,r+n-h,t,r+f,i,a,u)||q(t+e-l,r+l,l,0,0,i,a,u)||q(t+e-s,r+n-s,s,0,0,i,a,u)||q(t+h,r+n-h,h,0,0,i,a,u)||q(t+f,r+f,f,0,0,i,a,u)}(v,p,d,g,u.map((function(t){return k(t,0,Math.min(Math.abs(d)/2,Math.abs(g)/2))})),P,e.x,e.y)),O||!w&&!n||(O=o(t,e)),O}var S=P/2;return w&&x||n?R(v-S,p-S,d+S,g+S,e.x,e.y):w?R(v,p,d,g,e.x,e.y):!!x&&function(t,r,e,n,o,i,a){var u=o/2;return R(t-u,r-u,e,o,i,a)||R(t+e-u,r-u,o,n,i,a)||R(t+u,r+n-u,e,o,i,a)||R(t-u,r+u,o,n,i,a)}(v,p,d,g,P,e.x,e.y)}function V(t,r){var e=Object.keys(t);if(Object.getOwnPropertySymbols){var n=Object.getOwnPropertySymbols(t);r&&(n=n.filter((function(r){return Object.getOwnPropertyDescriptor(t,r).enumerable}))),e.push.apply(e,n)}return e}function tt(t){for(var r=1;arguments.length>r;r++){var e=null!=arguments[r]?arguments[r]:{};r%2?V(Object(e),!0).forEach((function(r){o(t,r,e[r])})):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(e)):V(Object(e)).forEach((function(r){Object.defineProperty(t,r,Object.getOwnPropertyDescriptor(e,r))}))}return t}function rt(t,e,n,o,i,a){var u=t.parsedStyle,c=u.pointerEvents,f=u.x,l=void 0===f?0:f,s=u.y,h=void 0===s?0:s,v=u.width,y=u.height;if("non-transparent-pixel"===(void 0===c?"auto":c)){var p=i.config.offscreenCanvas,d=a.offscreenCanvasCreator.getOrCreateCanvas(p),g=a.offscreenCanvasCreator.getOrCreateContext(p,{willReadFrequently:!0});return d.width=v,d.height=y,i.defaultStyleRendererFactory[r.Shape.IMAGE].render(g,tt(tt({},t.parsedStyle),{},{x:0,y:0}),t,void 0,void 0,void 0),g.getImageData(e.x-l,e.y-h,1,1).data.every((function(t){return 0!==t}))}return!0}function et(t,r,e,n){var o=t.getGeometryBounds();return!(o.min[0]>r.x||o.min[1]>r.y||r.x>o.max[0]||r.y>o.max[1])}var nt=function(t){function e(){var t,r,n,o;i(this,e);for(var a=arguments.length,u=Array(a),s=0;a>s;s++)u[s]=arguments[s];return r=this,n=e,o=[].concat(u),n=c(n),(t=l(r,f()?Reflect.construct(n,o||[],c(r).constructor):n.apply(r,o))).name="canvas-picker",t}return function(t,r){if("function"!=typeof r&&null!==r)throw new TypeError("Super expression must either be null or a function");t.prototype=Object.create(r&&r.prototype,{constructor:{value:t,writable:!0,configurable:!0}}),Object.defineProperty(t,"prototype",{writable:!1}),r&&s(t,r)}(e,t),u(e,[{key:"init",value:function(){var t,e=(o(o(o(o(o(o(o(o(o(o(t={},r.Shape.CIRCLE,W),r.Shape.ELLIPSE,H),r.Shape.RECT,K),r.Shape.LINE,Z),r.Shape.POLYLINE,J),r.Shape.POLYGON,z),r.Shape.PATH,$),r.Shape.TEXT,et),r.Shape.GROUP,null),r.Shape.IMAGE,rt),o(o(t,r.Shape.HTML,null),r.Shape.MESH,null));this.context.pointInPathPickerFactory=e,this.addRenderingPlugin(new S)}},{key:"destroy",value:function(){delete this.context.pointInPathPickerFactory,this.removeAllRenderingPlugins()}}])}(r.AbstractRendererPlugin);t.Plugin=nt}));
