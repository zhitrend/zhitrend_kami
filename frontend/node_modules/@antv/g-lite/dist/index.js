...
var addVec3 = glMatrix.vec3.add,
  copyVec3 = glMatrix.vec3.copy,
  maxVec3 = glMatrix.vec3.max,
  minVec3 = glMatrix.vec3.min,
  scaleVec3 = glMatrix.vec3.scale,
  subVec3 = glMatrix.vec3.sub;
...
var $vec3$2 = glMatrix.vec3.create();
function createVec3(x) {
  var y = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
  var z = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
  var clone = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
  if (Array.isArray(x) && x.length === 3) {
    return clone ? glMatrix.vec3.clone(x) : glMatrix.vec3.copy($vec3$2, x);
  }
  if (util.isNumber(x)) {
    return clone ? glMatrix.vec3.fromValues(x, y, z) : glMatrix.vec3.set($vec3$2, x, y, z);
  }
  return clone ? glMatrix.vec3.fromValues(x[0], x[1] || y, x[2] || z) : glMatrix.vec3.set($vec3$2, x[0], x[1] || y, x[2] || z);
}
...
var Camera = /*#__PURE__*/function () {
  ...
  return _createClass(Camera, [{
    ...
    value: function computeMatrix() {
      ...
      var rotX = glMatrix.quat.setAxisAngle(glMatrix.quat.create(), [1, 0, 0], deg2rad((this.rotateWorld && this.type !== CameraType.TRACKING || this.type === CameraType.TRACKING ? 1 : -1) * this.elevation));
      var rotY = glMatrix.quat.setAxisAngle(glMatrix.quat.create(), [0, 1, 0], deg2rad((this.rotateWorld && this.type !== CameraType.TRACKING || this.type === CameraType.TRACKING ? 1 : -1) * this.azimuth));
...
function mergeColors(left, right) {
  ...
  return [[Number(left.r), Number(left.g), Number(left.b), Number(left.alpha)], [Number(right.r), Number(right.g), Number(right.b), Number(right.alpha)], function (color) {
    ...
    if (rgba[3]) {
      for (var i = 0; i < 3; i++) rgba[i] = Math.round(util.clamp(rgba[i], 0, 255));
    }
...
var $mat4_1 = glMatrix.mat4.create();
var $mat4_2 = glMatrix.mat4.create();
var parser = {
  scale: function scale(d) {
    glMatrix.mat4.fromScaling($mat4_1, [d[0].value, d[1].value, 1]);
  },
  scaleX: function scaleX(d) {
    glMatrix.mat4.fromScaling($mat4_1, [d[0].value, 1, 1]);
  },
  scaleY: function scaleY(d) {
    glMatrix.mat4.fromScaling($mat4_1, [1, d[0].value, 1]);
  },
  scaleZ: function scaleZ(d) {
    glMatrix.mat4.fromScaling($mat4_1, [1, 1, d[0].value]);
  },
  scale3d: function scale3d(d) {
    glMatrix.mat4.fromScaling($mat4_1, [d[0].value, d[1].value, d[2].value]);
  },
  translate: function translate(d) {
    glMatrix.mat4.fromTranslation($mat4_1, [d[0].value, d[1].value, 0]);
  },
  translateX: function translateX(d) {
    glMatrix.mat4.fromTranslation($mat4_1, [d[0].value, 0, 0]);
  },
  translateY: function translateY(d) {
    glMatrix.mat4.fromTranslation($mat4_1, [0, d[0].value, 0]);
  },
  translateZ: function translateZ(d) {
    glMatrix.mat4.fromTranslation($mat4_1, [0, 0, d[0].value]);
  },
  translate3d: function translate3d(d) {
    glMatrix.mat4.fromTranslation($mat4_1, [d[0].value, d[1].value, d[2].value]);
  },
  rotate: function rotate(d) {
    glMatrix.mat4.fromZRotation($mat4_1, deg2rad(convertAngleUnit(d[0])));
  },
  rotateX: function rotateX(d) {
    glMatrix.mat4.fromXRotation($mat4_1, deg2rad(convertAngleUnit(d[0])));
  },
  rotateY: function rotateY(d) {
    glMatrix.mat4.fromYRotation($mat4_1, deg2rad(convertAngleUnit(d[0])));
  },
  rotateZ: function rotateZ(d) {
    glMatrix.mat4.fromZRotation($mat4_1, deg2rad(convertAngleUnit(d[0])));
  },
  rotate3d: function rotate3d(d) {
    glMatrix.mat4.fromRotation($mat4_1, deg2rad(convertAngleUnit(d[3])), [d[0].value, d[1].value, d[2].value]);
  },
  ...
  matrix: function matrix(d) {
    // prettier-ignore
    glMatrix.mat4.set($mat4_1, d[0].value, d[1].value, 0, 0, d[2].value, d[3].value, 0, 0, 0, 0, 1, 0, d[4].value, d[5].value, 0, 1);
  },
  matrix3d: function matrix3d(d) {
    // @ts-ignore
    glMatrix.mat4.set.apply(glMatrix.mat4, [$mat4_1].concat(_toConsumableArray(d.map(function (s) {
      return s.value;
    }))));
  }
};
var $vec3One$1 = glMatrix.vec3.fromValues(1, 1, 1);
var $vec3Zero$1 = glMatrix.vec3.create();
var optimizer = {
...
function parsedTransformToMat4(transform, object) {
  if (transform.length) {
    ...
    var m = glMatrix.mat4.identity($mat4_2);
...
var EventTarget = /*#__PURE__*/function () {
  ...
  return _createClass(EventTarget, [{
    ...
    value: function addEventListener(type, listener, options) {
      var capture = false;
      var once = false;
      if (util.isBoolean(options)) capture = options;else if (options) {
      ...
      var context = util.isFunction(listener) ? undefined : listener;
...
var $vec2Zero = glMatrix.vec2.create();
/** do not modify this objects */
var $vec3Zero = glMatrix.vec3.create();
/** do not modify this objects */
var $vec3One = glMatrix.vec3.fromValues(1, 1, 1);
/** do not modify this objects */
var $mat4Identity = glMatrix.mat4.create();

/** shared objects */
var $vec2 = glMatrix.vec2.create();
/** shared objects */
var $vec3$1 = glMatrix.vec3.create();
/** shared objects */
var $mat4 = glMatrix.mat4.create();
/** shared objects */
var $quat$1 = glMatrix.quat.create();
var $setLocalTransform_1 = glMatrix.vec3.create();
var $setLocalTransform_2 = glMatrix.quat.create();
var $setLocalTransform_3 = glMatrix.vec3.create();
var $setLocalPosition = glMatrix.vec3.create();
var $setPosition_1 = glMatrix.vec3.create();
var $setPosition_ParentInvertMatrix = glMatrix.mat4.create();
var $setEulerAngles_InvParentRot = glMatrix.quat.create();
var $rotateLocal = glMatrix.quat.create();
var $rotate_ParentInvertRotation = glMatrix.quat.create();
  ...
  return _createClass(DefaultSceneGraphService, [{
    ...
    value: function rotate(element, degrees) {
      ...
      if (element.parentNode === null || !element.parentNode.transformable) {
        ...
        glMatrix.quat.copy($rotate_ParentInvertRotation, parentRot);
        glMatrix.quat.invert($rotate_ParentInvertRotation, $rotate_ParentInvertRotation);
        glMatrix.quat.multiply(rotation, $rotate_ParentInvertRotation, rotation);
    ...
    value: function rotateLocal(element, degrees) {
      ...
      var transform = element.transformable;
      glMatrix.quat.fromEuler($rotateLocal, degrees[0], degrees[1], degrees[2]);
      glMatrix.quat.mul(transform.localRotation, transform.localRotation, $rotateLocal);
      this.dirtifyLocal(element, transform);
    }
    ...
    value: function setEulerAngles(element, degrees) {
      ...
      if (element.parentNode === null || !element.parentNode.transformable) {
        ...
        glMatrix.quat.copy($setEulerAngles_InvParentRot, glMatrix.quat.invert($quat$1, parentRotation));
        glMatrix.quat.mul(transform.localRotation, transform.localRotation, $setEulerAngles_InvParentRot);
        this.dirtifyLocal(element, transform);
      }
    }
    ...
    value: function translateLocal(element, translation) {
      ...
      var transform = element.transformable;
      if (glMatrix.vec3.equals(translation, $vec3Zero)) return;
    ...
    value: function setPosition(element, position) {
      ...
      if (glMatrix.vec3.equals(this.getPosition(element), $setPosition_1)) {
        return;
      }
      glMatrix.vec3.copy(transform.position, $setPosition_1);
      if (element.parentNode === null || !element.parentNode.transformable) {
        glMatrix.vec3.copy(transform.localPosition, $setPosition_1);
      } else {
        var parentTransform = element.parentNode.transformable;
        glMatrix.mat4.copy($setPosition_ParentInvertMatrix, parentTransform.worldTransform);
        glMatrix.mat4.invert($setPosition_ParentInvertMatrix, $setPosition_ParentInvertMatrix);
        glMatrix.vec3.transformMat4(transform.localPosition, $setPosition_1, $setPosition_ParentInvertMatrix);
      }
      this.dirtifyLocal(element, transform);
    }
    ...
    value: function setLocalPosition(element, position) {
      ...
      if (glMatrix.vec3.equals(transform.localPosition, $setLocalPosition)) {
        return;
      }
      glMatrix.vec3.copy(transform.localPosition, $setLocalPosition);
      if (dirtify) {
        this.dirtifyLocal(element, transform);
      }
    }
    ...
    value: function scaleLocal(element, scaling) {
      var _scaling$;
      var transform = element.transformable;
      glMatrix.vec3.multiply(transform.localScale, transform.localScale, glMatrix.vec3.set($vec3$1, scaling[0], scaling[1], (_scaling$ = scaling[2]) !== null && _scaling$ !== void 0 ? _scaling$ : 1));
      this.dirtifyLocal(element, transform);
    }
  }, {
    key: "setLocalScale",
    value: function setLocalScale(element, scaling) {
      ...
      var dirtify = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
      var transform = element.transformable;
      glMatrix.vec3.set($vec3$1, scaling[0], scaling[1], (_scaling$2 = scaling[2]) !== null && _scaling$2 !== void 0 ? _scaling$2 : transform.localScale[2]);
      if (glMatrix.vec3.equals($vec3$1, transform.localScale)) {
        return;
      }
      glMatrix.vec3.copy(transform.localScale, $vec3$1);
      if (dirtify) {
        this.dirtifyLocal(element, transform);
      }
    }
    ...
    value: function translate(element, translation) {
      ...
      var z = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0;
      if (typeof translation === 'number') {
        translation = glMatrix.vec3.set($vec3$1, translation, y, z);
      }
      if (glMatrix.vec3.equals(translation, $vec3Zero)) return;
      glMatrix.vec3.add($vec3$1, this.getPosition(element), translation);
    ...
    value: function setRotation(element, rotation, y, z, w) {
      ...
      if (element.parentNode === null || !element.parentNode.transformable) {
        ...
        var parentRot = this.getRotation(element.parentNode);
        glMatrix.quat.copy($quat$1, parentRot);
        glMatrix.quat.invert($quat$1, $quat$1);
        glMatrix.quat.multiply(transform.localRotation, $quat$1, rotation);
        glMatrix.quat.normalize(transform.localRotation, transform.localRotation);
        this.dirtifyLocal(element, transform);
      }
    }
    ...
    value: function setLocalRotation(element, rotation, y, z, w) {
      ...
      if (typeof rotation === 'number') {
        rotation = glMatrix.quat.set($quat$1, rotation, y, z, w);
      }
      var transform = element.transformable;
    ...
    value: function setLocalSkew(element, skew, y) {
      ...
      if (typeof skew === 'number') {
        skew = glMatrix.vec2.set($vec2, skew, y);
      }
      var transform = element.transformable;
    ...
    value: function calcLocalTransform(transform) {
      ...
      if (hasSkew) {
        ...
        if (transform.localSkew[0] !== 0 || transform.localSkew[1] !== 0) {
          glMatrix.mat4.identity($mat4);
          $mat4[4] = Math.tan(transform.localSkew[0]);
          $mat4[1] = Math.tan(transform.localSkew[1]);
          glMatrix.mat4.multiply(transform.localTransform, transform.localTransform, $mat4);
        }
        var scaling = glMatrix.mat4.fromRotationTranslationScaleOrigin($mat4, glMatrix.quat.set($quat$1, 0, 0, 0, 1), glMatrix.vec3.set($vec3$1, 1, 1, 1), transform.localScale, transform.origin);
    ...
    value: function setLocalTransform(element, transform) {
      var t = glMatrix.mat4.getTranslation($setLocalTransform_1, transform);
      var r = glMatrix.mat4.getRotation($setLocalTransform_2, transform);
      var s = glMatrix.mat4.getScaling($setLocalTransform_3, transform);
    ...
    value: function getLocalBounds(element) {
      if (element.parentNode) {
        ...
        if (element.parentNode.transformable) {
          parentInvert = glMatrix.mat4.invert($mat4, this.getWorldTransform(element.parentNode));
        }
...
var DisplayObject = /*#__PURE__*/function (_Element) {
  ...
  return _createClass(DisplayObject, [{
    ...
    value: function getMatrix(transformMat4) {
      ...
      var _mat4$getTranslation = glMatrix.mat4.getTranslation($vec3, transform),
        _mat4$getTranslation2 = _slicedToArray(_mat4$getTranslation, 2),
        tx = _mat4$getTranslation2[0],
        ty = _mat4$getTranslation2[1];
      var _mat4$getScaling = glMatrix.mat4.getScaling($vec3, transform),
        _mat4$getScaling2 = _slicedToArray(_mat4$getScaling, 2),
        sx = _mat4$getScaling2[0],
        sy = _mat4$getScaling2[1];
      var rotation = glMatrix.mat4.getRotation($quat, transform);
...
var Line = /*#__PURE__*/function (_DisplayObject) {
  ...
  return _createClass(Line, [{
    ...
    value: function getPoint(ratio) {
      ...
      var _linePointAt = gMath.linePointAt(x1, y1, x2, y2, ratio),
        x = _linePointAt.x,
        y = _linePointAt.y;
...
var Polyline = /*#__PURE__*/function (_Polygon) {
  ...
  return _createClass(Polyline, [{
    ...
    value: function getPoint(ratio) {
      ...
      var _linePointAt = gMath.linePointAt(points[index][0], points[index][1], points[index + 1][0], points[index + 1][1], subt),
        x = _linePointAt.x,
        y = _linePointAt.y;
      var transformed = glMatrix.vec3.transformMat4(glMatrix.vec3.create(), glMatrix.vec3.fromValues(x, y, 0), inWorldSpace ? this.getWorldTransform() : this.getLocalTransform());
  ...
  function Document() {
    ...
    BUILT_IN_PROPERTIES.forEach(function (_ref) {
      var n = _ref.n,
        ...
        d = _ref.d;
      if (inh && d) {
        initialStyle[n] = util.isFunction(d) ? d(Shape.GROUP) : d;
      }
    });
...
exports.CameraProjectionMode = CameraProjectionMode;
exports.CameraTrackingMode = CameraTrackingMode;
exports.CameraType = CameraType;
exports.Canvas = Canvas;
exports.CanvasEvent = CanvasEvent;
exports.Circle = Circle;
exports.CircleUpdater = CircleUpdater;
exports.ClipSpaceNearZ = ClipSpaceNearZ;
...
exports.Shape = Shape;
exports.SortReason = SortReason;
exports.Strategy = Strategy;
exports.Text = Text;
exports.TextService = TextService;
exports.TextUpdater = TextUpdater;
exports.UnitType = UnitType;
exports.attrModifiedEvent = attrModifiedEvent;
...
exports.insertedEvent = insertedEvent;
